...
final AdminPanelSnapshot _sampleSnapshot = AdminPanelSnapshot(
  ...
  pricingConfig: const AdminPricingConfig(
    ...
    commissionRate: 0.10,
    fleetOwnerCommissionRate: 0.10,
    bookingFeeNgn: 100,
    bookingFeeMode: 'max_fixed_or_percentage',
    bookingFeePercent: 3,
    bookingFeeMinNgn: 100,
    dispatchBookingFeeNgn: 150,
    dispatchBookingFeeMode: 'max_fixed_or_percentage',
    dispatchBookingFeePercent: 5,
    dispatchBookingFeeMinNgn: 150,
    weeklySubscriptionNgn: 7000,
    monthlySubscriptionNgn: 25000,
    fleetWeeklySubscriptionNgn: 7000,
    fleetMonthlySubscriptionNgn: 25000,
