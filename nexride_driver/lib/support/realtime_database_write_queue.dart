...
/// Serializes Firebase RTDB native writes so the Android plugin does not spawn
/// unbounded `update` worker threads (pthread_create OOM).
...
/// Critical-path RTDB writes (chat, presence) share the same single-flight queue.
